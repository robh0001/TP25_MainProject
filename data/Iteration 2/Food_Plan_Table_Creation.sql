...
CREATE TABLE nutrition_plan (
    ...
    day_number       INT                NOT NULL  COMMENT 'Day of the week (1 to 7)',
    meal_type        VARCHAR(20)        NOT NULL  COMMENT 'Breakfast, Lunch, Dinner, or Snack',
    meal_name        VARCHAR(150)       NOT NULL  COMMENT 'Name of the meal or food item',
    description      VARCHAR(1000)      NOT NULL  COMMENT 'Paraphrased description of the meal',
    calories         INT                NOT NULL  COMMENT 'Energy per serving (kcal)',
    protein_g        DECIMAL(5,1)       NOT NULL  COMMENT 'Protein per serving (g)',
    carbohydrates_g  DECIMAL(5,1)       NOT NULL  COMMENT 'Carbohydrates per serving (g)',
    fat_g            DECIMAL(5,1)       NOT NULL  COMMENT 'Total fat per serving (g)',
    fibre_g          DECIMAL(5,1)       NOT NULL  COMMENT 'Dietary fibre per serving (g)',
    sodium_mg        DECIMAL(7,1)       NOT NULL  COMMENT 'Sodium per serving (mg)',
    calcium_mg       DECIMAL(7,1)       NOT NULL  COMMENT 'Calcium per serving (mg)',
