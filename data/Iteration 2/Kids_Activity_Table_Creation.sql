...
CREATE TABLE exercise_plan (
    ...
    letter        CHAR(1)           NOT NULL COMMENT 'Alphabet letter the exercise is associated with',
    exercise_name VARCHAR2(100)     NOT NULL COMMENT 'Name of the exercise activity',
